    ...
    <div className="flex h-screen w-full bg-[#F8F9FA] font-manrope overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto px-8 py-8">
        ...
        <div className="mb-8 flex items-start justify-between">
          ...
          <button className="flex items-center gap-2 rounded-full bg-[#7E8E21] px-5 py-3 text-sm font-bold text-[#E8FFE8] shadow-lg transition hover:bg-[#3d4519] active:scale-95">
            <RiAddLine size={18} />
            Quick Add
          </button>
        </div>

        {/* Row 1: Budget + Expiring */}
